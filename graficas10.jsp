...
linea="select * from encuesta where cve_preguntas=10";
...
<div align="center">
    ...
    <div id="chart_div"></div>
		...
		<div align="right">
					<a href="graficas9.jsp"><img width="100" height="50" align="left" src="complementos/imagen/regresar.png"></a>
                    <a href="principal.jsp"><img width="100" height="50" align="right" src="complementos/imagen/siguiente.png"></a>
		</div>
